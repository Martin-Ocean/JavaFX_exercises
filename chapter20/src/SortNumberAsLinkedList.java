...
public class SortNumberAsLinkedList extends Application {
  ...
  public void start(Stage primaryStage) {    
    ...
    hBoxForButtons.getChildren().addAll(btSort, btShuffle, btReverse, btDouble);
    hBoxForButtons.setAlignment(Pos.CENTER);
    borderPane.setBottom(hBoxForButtons);
        
    // Create a scene and place it in the stage
    Scene scene = new Scene(borderPane, 400, 210);
    primaryStage.setTitle("SortNumberAsLinkedList"); // Set the stage title
