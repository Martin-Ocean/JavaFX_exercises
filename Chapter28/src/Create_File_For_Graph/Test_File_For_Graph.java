...
public class Test_File_For_Graph {
    public static void main(String [] args) {
        ...
        Graph<Integer> graph = new UnWeightedGraph<Integer>(edges, verts);
     //   System.out.println("graph");
      ...
      //  System.out.println("delete");
        ...
        try {
            ...
            out.println(graph.getSize());
           // System.out.println("getsize");

            for (int i = 0; i < graph.getSize(); i++) {
                out.print(graph.getVertex(i) + " ");
              //  System.out.println("out vertex");

                graph.getNeighbors(i).forEach(item -> out.print(  item + " "));
            }
    ...
    public static class UnWeightedGraph<V> extends AbstractGraph {
        /** Construct an empty graph */
