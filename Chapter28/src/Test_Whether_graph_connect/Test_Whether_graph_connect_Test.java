package Test_Whether_graph_connect;

import java.util.*;

public class Test_Whether_graph_connect_Test {
    public static void main(String[] args) throws Exception {
        ...
        // Test_Whether_graph_connect_Test if file exists
        if (!file.exists()) {
        ...
        String[] vertices = new String[vert];
        ...
        // Test_Whether_graph_connect_Test if graph is connected and print results
