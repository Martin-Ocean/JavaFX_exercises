...
class FanPane extends Pane {
  ...
  public FanPane() {
    ...
    String[] color = new String[]{"black", "beige", "gray", "green", "red", "gold", "aqua", "navy"};
    for (int i = 0; i < 8; i++) {
      arc[i] = new Arc(w / 2, h / 2, radius * 0.9, radius * 0.9, startAngle + i * 45, 20);
      arc[i].setFill(Color.valueOf(color[i])); // Set fill color
  ...
  public void setValues() {
    ...
    for (int i = 0; i < 8; i++) {
      ...
      arc[i].setStartAngle(startAngle + i * 45);
    }     
  }
